...
own database live in, which is where `main.lua` opens that database. Nothing
under busted opens it -- see the `lua-ljsqlite3/init` stub -- so the path is a
marker rather than somewhere to write.
]]
