...
them touches it until a store is opened, which no spec does: the modules above
those stores take one as a dependency and specs hand them an in-memory
stand-in instead (`spec/support/fake_session_store.lua`,
